...
type='text/css' />
<link href="{{asset('public/backend/css/style-responsive.css')}}"
rel="stylesheet"/>
<link href="{{asset('public/backend/css/main.css')}}"
rel="stylesheet"/>
<!-- font CSS -->
<link
...
<aside>
 ...
 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/found-order-week')}}">Thống kê theo tuần </a></li>
                        <li><a href="{{URL::to('/found-order-month')}}">Thống kê theo tháng</a></li>
...
<li class="sub-menu">
	...
	<ul class="sub">
	<li><a href="{{URL::to('/add-news')}}">Thêm tin</a></li>
	</ul>
</li>
 <li>
 <a href="login.html">
...
<script
src="{{asset('public/backend/js/jquery.dcjqaccordion.2.7.js')}}"></script>
