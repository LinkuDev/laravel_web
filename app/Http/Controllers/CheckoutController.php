   ...
   public function login_checkout(Request $request){
	...
	public function payment(Request $request){
		...
		public function order_place(Request $request){
			...
			$to_email = $request->payment_email;
			//send to this email
		...
		public function manage_order(){
			//$this->AuthLogin();
			$all_order = DB::table('tbl_order')->join('customers','tbl_order.customer_id','=','customers.customer_id')->select('tbl_order.*','customers.customer_name')->orderby('tbl_order.order_id','desc')->get();
		...
		public function user_setting(Request $request){
			...
			$cate_product = DB::table('tbl_category_product')->where('category_status','1')->orderby('category_id','desc')->get();
			$brand_product = DB::table('tbl_brand')->where('brand_status','1')->orderby('brand_id','desc')->get();
			$manager_order = DB::table('tbl_order')->join('customers','tbl_order.customer_id','=','customers.customer_id')->select('tbl_order.*','customers.customer_name')->where('tbl_order.customer_id',$customer_id)->orderby('tbl_order.order_id','desc')->get();
		...
		public function update_order($order_id){
			...
			return Redirect::to('mamage-order');

		}
		public function delete_order($order_id){
			//$this->AuthLogin();
			DB::table('tbl_order')->where('order_id',$order_id)->delete();
			Session::put('message','Xóa đơn hànng thành công');
