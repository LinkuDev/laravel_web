...
public function show_order_month(Request $request){
    ...
    if( $month && $year)
    {
         $all_order = DB::table('tbl_order')->where(DB::raw("DATE_FORMAT(created_at, '%m-%Y')"),"$month-$year")->get();
        return view('admin.month_order')->with('all_order',$all_order);
        
    }

        return view('admin.day_order');
   }
   public function show_order_week(Request $request){
    ...
    {
         $all_order = DB::table('tbl_order')->where(DB::raw("DATE_FORMAT(created_at, '%d-%m-%Y')"),"$day-$month-$year")->get();
        return view('admin.week_order')->with('all_order',$all_order);
